...
<head>
  ...
  <title>Dino Run - Professional Edition</title>
  <style>
...
<body>
  ...
  <script>
    ...
    function drawMenu() {
      ...
      ctx.fillText('SPACE or ↑ to Jump', canvas.width / 2, canvas.height / 2 + 80);
      ctx.fillText('↓ to Duck', canvas.width / 2, canvas.height / 2 + 100);
